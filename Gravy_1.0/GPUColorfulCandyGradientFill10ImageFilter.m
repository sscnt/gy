...
@implementation GPUColorfulCandyGradientFill10ImageFilter

NSString *const kGPUColorfulCandyGradientFill10ImageFilterFragmentShaderString = SHADER_STRING
(
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kGPUColorfulCandyGradientFill10ImageFilterFragmentShaderString]))
    {
        return nil;
    }
