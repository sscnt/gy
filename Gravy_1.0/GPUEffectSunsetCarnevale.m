...
- (UIImage*)process
{
    ...
    // Curve
    @autoreleasepool {
        GPUImageToneCurveFilter* curveFilter = [[GPUImageToneCurveFilter alloc] initWithACV:@"SunsetCarnevale1"];
    ...
    @autoreleasepool {
        ...
        [gradientMap addColorRed:9.0f Green:0.0f Blue:178.0f Opacity:1.0f Location:0 Midpoint:50];
        [gradientMap addColorRed:255.0f Green:0.0f Blue:0.0f Opacity:1.0f Location:2048 Midpoint:50];
        [gradientMap addColorRed:255.0f Green:252.0f Blue:0.0f Opacity:1.0f Location:4096 Midpoint:50];
