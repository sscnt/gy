...
- (UIImage*)process
{
    ...
    // Curve
    @autoreleasepool {
        GPUImageToneCurveFilter* curveFilter = [[GPUImageToneCurveFilter alloc] initWithACV:@"Vanilla2"];
    ...
    @autoreleasepool {
        ...
        [gradientMap addColorRed:40.0f Green:24.0f Blue:24.0f Opacity:1.0f Location:0 Midpoint:50];
        [gradientMap addColorRed:64.0f Green:78.0f Blue:94.0f Opacity:1.0f Location:4096 Midpoint:50];
    ...
    // Curve
    @autoreleasepool {
        GPUImageToneCurveFilter* curveFilter = [[GPUImageToneCurveFilter alloc] initWithACV:@"Vanilla3"];
